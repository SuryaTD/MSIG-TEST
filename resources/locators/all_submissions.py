...
UpdateWorkflowStage = "xpath=//*[text()='Update Workflow Stage']"
ReasonForReject1 = "xpath=//div[text()='"
ReasonForReject2 = "']//preceding-sibling::input"
SelectReason = "xpath=//span//*[normalize-space()='Select reason']"
Details = "xpath=//*[text()='Update Workflow Stage']//following-sibling::textarea"
...
SanctionScreeningTaskDetails = {"TaskPriority":"xpath=//div[@test-id='task-priority']",
               ...
               "AssignedTo":"xpath=//div[@ng-if='!$ctrl.task.assigned_to.email && !$ctrl.task.assigned_to.user_id' or @ng-if='$ctrl.task.assigned_to.email || $ctrl.task.assigned_to.user_id']",
...
#Rajesh
Convr_Task_tab="xpath=//a[text()='Tasks']"
Convr_Submission_tab="xpath=//a[text()='Submissions']"
Convr_Status_Filter_Button="xpath=//div[@col-id='status']//span[@data-ref='eFilterButton']"
Convr_EffDate_Filter_Button="xpath=//div[@col-id='submission.effectiveDate']//span[@data-ref='eFilterButton']"
Convr_Select_All_Option="xpath=//div[@data-ref='eSetFilterList']//div[text()='(Select All)']"
Convr_Completed_Option="xpath=//div[@data-ref='eSetFilterList']//div[text()='Completed']"
Convr_Status_Elements="xpath=(//div[@role='gridcell' and @col-id='status'])[1]"
Convr_Effdate_Elements="xpath=//div[@role='gridcell' and @col-id='submission.effectiveDate']"
Convr_Effdate_field="xpath=(//input[@aria-label='Filter Value'])[1]"
Convr_Check_Box="xpath=(//input[@aria-label='Press Space to toggle row selection (unchecked)'])[1]"
Convr_Reassign="xpath=(//div[@data-align='start']//div)[1]"
Convr_Reassign_Input_Field="xpath=//input[@data-slot='command-input']"
Convr_Reassign_Sucess_popup="xpath=//div[text()='Tasks reassigned successfully']"
Convr_Reassign_Option="xpath=(//div[@data-slot='command-item'])[1]"
Convr_Cant_Reassign_Msg="//section[@aria-label='Notifications alt+T']//div[@data-description]"
Convr_Created_Option="xpath=//div[@data-ref='eSetFilterList']//div[text()='CREATED']"

More_Option_Sov="xpath=//button[@test-id='asset-card-options-menu-sov']" 
Stop_Option="xpath=//button[@data-cy='asset-card-options-stop-sov']"
Force_HITL="xpath=(//button[@data-cy='asset-card-options-reprocess-sov'])[2]"
Sov_DropDown_Option="xpath=//select[@data-cy='asset-card-select-sov']"
Label_Side_Menu="xpath=//section[@id='submission-sidebar-labels']//span"
Quality_Control_Side_Menu="xpath=//submission-sidebar-qc//button"
All_field_Side_Menu="xpath=//*[@name='submission-sidebar']//span[not(@class='ng-scope')]|//*[@name='submission-sidebar']//*[text()='Quality Control']/..//button"
